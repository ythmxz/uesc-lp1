/*
Lista de Exercícios I - Questão #09
...
int main() {
  ...
  printf("\n\nA distância euclidiana do ponto (%g, %g) à origem equivale a %g.", pontoX, pontoY, pontoZ);

  pontoZ = (pontoX * pontoY);

  printf("\n\nO produto entre os pontos %g e %g equivale a %e.", pontoX, pontoY, pontoZ);
