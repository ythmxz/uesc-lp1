/*
Lista de Exercícios I - Questão #01
...
int main() {
  ...
  printf("\nb) As linguagens de Programação se diversificaram bastante ao longo do"
        " tempo e seguiram por diversos caminhos diferentes, podendo ser classificadas"
				" por seu paradigma, sua estrutura de tipos, sua plataforma de desenvolvimento,"
